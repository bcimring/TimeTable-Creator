...
from Person_Student_and_Teacher_Class import*
from Classroom_Schedule_Class import*
...
name_file = open('stuName_num_gr_data.txt','w')
mand_file = open('stuMand_data.txt','w')
elect_file = open('stuElect_data.txt','w')
alt_file = open('stuAlt_data.txt','w')
...
def load_teacher_data():                                # open teacher data classes and put teachers into a list
    teacherClasses = open('teacher_subject_data.txt','r')
    ...
    teacherNameList = open('teacher_name_data.txt','r')
...
name_file = open('stuName_num_gr_data.txt','r')
mand_file = open('stuMand_data.txt','r')
elect_file = open('stuElect_data.txt','r')
alt_file = open('stuAlt_data.txt','r')
...
room_data = open('classroom_data.txt','r')

rooms = [line[:-1] for line in room_data.readlines()]

subject_data = open('classroom_subject_data.txt','r')
...
#############################################################################
                                                                            #
studentData = open('[AFTER_SORTING]_student_semester_data.txt','w')         #
optionData = open('[AFTER_SORTING]_student_course_options.txt','w')         #
classroomScheduleData = open('[AFTER_SORTING]_classrooms_schedule.txt','w')
teacherScheduleData = open('[AFTER_SORTING]_teacher_semester_data.txt','w')
